...
public final class RotationPolicy {
    ...
    private static boolean isCurrentRotationAllowed(Context context) {
        ...
        final IWindowManager wm = WindowManagerGlobal.getWindowManagerService();
        try {
            return isRotationAllowed(wm.getDefaultDisplayRotation(),
                    userRotationAngles, allowAllRotations);
    ...
    private static int getNaturalRotationConfig() {
        ...
        if (primaryDisplayOrientation == "ORIENTATION_90") { return Surface.ROTATION_90; }
        if (primaryDisplayOrientation == "ORIENTATION_180") { return Surface.ROTATION_180; }
        if (primaryDisplayOrientation == "ORIENTATION_270") { return Surface.ROTATION_270; }
